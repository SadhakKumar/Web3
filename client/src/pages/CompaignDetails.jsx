            ...
            <div className='mt-[20px] flex flex-col gap-4'>
              {donators.length > 0 ? donators.map((item, index) => (
                <div key={`${item.donator} -${index}`} className='flex justify-between items-center gap-4'>
                  <p className='font-epilogue font-normal text-[16px] text-[#b2b3bd] leading-[26px] break-li'>{index + 1}.{item.donator}</p>
                  <p className='font-epilogue font-normal text-[16px] text-[#b2b3bd] leading-[26px] break-li'>{item.donations}</p>
                </div>
              )) : (
          ...
          <div className='mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]'>
            ...
            <div className='mt-[30px]'>
              ...
              <div className='mt-[20px] p-4 bg-{#13131a] rounded-[10px]'>
                <h4 className='font-epilogue font-semibold text-[16px] leading-[22px] text-white'>Back it because you believe in it.</h4>
